...
// 	cpu.C = cpu.read(cpu.PC)
// 	cpu.PC++
// }

// // LD DE, u16 DONE
// func op_0x11(cpu *CPU) {
// 	cpu.D = cpu.read(cpu.PC + 1)
// 	cpu.E = cpu.read(cpu.PC)
// 	cpu.PC += 2
// }
...
// 	cpu.A = cpu.read(uint16(cpu.D) << 8 | uint16(cpu.E))
// 	cpu.A &= 0xFF
// }
...
// 	cpu.H = cpu.read(cpu.PC + 1)
// 	cpu.L = cpu.read(cpu.PC)
// 	cpu.PC += 2
// }

// // LD (HL+), A DONE
// func op_0x22(cpu *CPU) {
// 	cpu.write((uint16(cpu.H) << 8 | uint16(cpu.L)), cpu.A)
// 	cpu.L++
// 	if cpu.L == 0x00 {
// 		cpu.H++
// 	}
...
// 	cpu.write(cpu.SP, cpu.C)
// 	cpu.SP++
// 	cpu.write(cpu.SP, cpu.B)
// 	cpu.SP++
// }
...
// 	cpu.PC = uint16(cpu.read(cpu.SP + 1)) << 8 | uint16(cpu.read(cpu.SP))
// 	cpu.SP += 2
// }
...
// 	cpu.SP--
// 	cpu.write(cpu.SP, lo)
// 	cpu.PC = cpu.read16Bit(cpu.PC)
// }

// // LD (FF00 + u8), A DONE
// func op_0xE0(cpu *CPU) {
// 	cpu.write((0xFF00 + uint16(cpu.read(cpu.PC))), cpu.A)
// 	cpu.PC++
// }
...
// 	cpu.write((uint16(cpu.read(cpu.PC + 1))) << 8 | uint16((cpu.read(cpu.PC))), cpu.A)
// 	cpu.PC += 2
// }

// // LD A, (FF00 + u8)
// func op_0xF0(cpu *CPU) {
// 	cpu.A = cpu.read(0xFF00 + uint16(cpu.read(cpu.PC)))
// 	cpu.PC++
...
// 	}
// 	cpu.NFlag(1)
// 	if ((cpu.A + cpu.read(cpu.PC)) & 0x10) != (result & 0x10) {
// 		cpu.HFlag(1)
// 	}
// 	if (result < 0) {
// 		cpu.CFlag(1)
...
var opcodes [256]Opcode = [256]Opcode {
	Opcode{4, op_null}, Opcode{12, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_0x04}, Opcode{4, op_0x05}, Opcode{8, op_0x06}, Opcode{4, op_null}, Opcode{20, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_0x0C}, Opcode{4, op_0x0D}, Opcode{8, op_0x0E}, Opcode{4, op_null},
	...
	Opcode{4, op_null}, Opcode{12, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{4, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{20, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{4, op_null}, Opcode{8, op_null}, Opcode{4, op_null},
	Opcode{4, op_null}, Opcode{12, op_0xC1}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{16, op_0xC5}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{20, op_null}, Opcode{16, op_0xC9}, Opcode{8, op_null}, Opcode{4, op_0xCB}, Opcode{4, op_null}, Opcode{24, op_0xCD}, Opcode{8, op_null}, Opcode{4, op_null},
	Opcode{4, op_null}, Opcode{12, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{4, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{20, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{8, op_null}, Opcode{4, op_null}, Opcode{4, op_null}, Opcode{8, op_null}, Opcode{4, op_null},
